...
namespace IdentitySample.Identity.MongoDb.Models
{
        ...
        where TUser : IdentityUser
    {
        ...
        {
            return Task.Run(() => _context.UsersCollection.Insert(user));
        }

        public virtual Task UpdateAsync(TUser user)
        {
            // todo should add an optimistic concurrency check
            return Task.Run(() => _context.UsersCollection.Save(user));
        }

        public virtual Task DeleteAsync(TUser user)
        {
            var queryById = Query<TUser>.EQ(u => u.Id, user.Id);
            return Task.Run(() => _context.UsersCollection.Remove(queryById));
        }

        public virtual Task<TUser> FindByIdAsync(string userId)
        {
            var queryById = Query.EQ("_id", new BsonObjectId(new ObjectId(userId)));
            return Task.Run(() => _context.UsersCollection.FindOneAs<TUser>(queryById));
        }
        ...
        public virtual Task<TUser> FindByNameAsync(string userName)
        {
            ...
            return Task.Run(() => _context.UsersCollection.FindOneAs<TUser>(queryByName));
        }
        ...
        {
            return Task.Factory
                .StartNew(() => _context.UsersCollection.AsQueryable<TUser>()
        ...
        public virtual Task<TUser> FindByEmailAsync(string email)
        {
            ...
            return Task.Run(() => _context.UsersCollection.AsQueryable<TUser>().FirstOrDefault(u => u.Email == email));
        }
        ...
        public virtual IQueryable<TUser> Users
        {
            get
            {
                return _context.UsersCollection.AsQueryable<TUser>();
            }
        }
